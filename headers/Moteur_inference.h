...
/**
 * Applique le moteur d'inférence sur la base de faits en fonction de la base de connaissances.
 *
 * @param liste_BF La liste des faits de la base de faits.
 * @param liste_BC La liste des règles de la base de connaissances.
 * @return La liste des faits mise à jour après l'application du moteur d'inférence.
 */
